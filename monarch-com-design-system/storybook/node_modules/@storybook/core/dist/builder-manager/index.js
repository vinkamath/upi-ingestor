...
var R = (e, i) => () => (i || e((i = { exports: {} }).exports, i), i.exports), z = (e, i) => {
  ...
  if (i && typeof i == "object" || typeof i == "function")
    for (let r of Rt(i))
      !Lt.call(e, r) && r !== t && A(e, r, { get: () => i[r], enumerable: !(a = kt(i, r)) || a.enumerable });
  return e;
};
var $ = (e, i, t) => (t = e != null ? Tt(Ft(e)) : {}, ue(
        ...
        m.add("require"), n.onResolve({ filter: t }, (g) => {
          ...
          if (P) {
            ...
            if (M) {
              ...
              V?.linkType === "SOFT" && k.push((y = (h = w.resolveVirtual) === null || h === void 0 ? void 0 : h.call(w, P)) !== null && y !==
              void 0 ? y : P);
            }
          }
          return a(g, { resolvedPath: P, error: S, watchFiles: k });
...
` + bi;
  ...
  try {
    typeof Object.defineProperty == "function" ? Object.defineProperty(T.escapeXML, "toString", { value: it }) : T.escapeXML.toString = it;
  } catch {
...
var ft = R((x) => {
  "use strict";
  var re = O("fs"), N = O("path"), b = at(), nt = !1, ji = rt().version, Oi = "<", Ei = ">", Pi = "%", mt = "locals", Si = "ejs", Ti = "(<%%\
|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)", ut = [
    "delimiter",
    "scope",
    "context",
    ...
    "filename",
    "async"
  ], ki = ut.concat("cache"), ot = /^\uFEFF/, ae = /^[a-zA-Z_$][0-9a-zA-Z_$]*$/;
  x.cache = b.cache;
...
kThirdPartyPackageFromPath"), ce = /* @__PURE__ */ o(async (e) => {
  let i = {}, { builder: t, channelOptions: a } = await e.presets.apply("core"), r = await Ui(e), n = await yt(r);
  e.configType === "DEVELOPMENT" && (i.CHANNEL_OPTIONS = { wsToken: a?.wsToken }), n && (i.STORYBOOK_RENDERER = await yt(r) ?? void 0);
  let s = vt(t);
  s && (i.STORYBOOK_BUILDER = Gi(s) ?? Vi(s));
  let c = vt(await e.presets.apply("framework"));
...
var pa = /^\/($|\?)/, G, C, xt = /* @__PURE__ */ o(async (e) => {
  ...
  return yield, a.use("/", ({ url: P }, S, k) => {
    P && pa.test(P) ? (S.statusCode = 200, S.setHeader("Content-Type", "text/html"), S.write(w), S.end()) : k();
