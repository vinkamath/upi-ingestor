...
module.exports = z(ta);
var I = require("node:fs/promises"), k = require("node:path"), It = require("@storybook/core/common"), Mt = require("@storybook/core/manager/globals-module-info"),
...
var Rt = require("node:path"), B = require("@storybook/core/common");
var kt = /* @__PURE__ */ o((e) => {
  if (e)
    return typeof e == "string" ? e : e.name;
}, "pluckNameFromConfigProperty"), Ft = /* @__PURE__ */ o((e) => e.replaceAll(Rt.sep, "/"), "normalizePath"), Ji = /* @__PURE__ */ o((e) => Ft(
...
luckThirdPartyPackageFromPath"), ve = /* @__PURE__ */ o(async (e) => {
  let i = {}, { builder: t, channelOptions: a } = await e.presets.apply("core"), r = await (0, B.getFrameworkName)(e), n = await (0, B.extractProperRendererNameFromFramework)(
  r);
  e.configType === "DEVELOPMENT" && (i.CHANNEL_OPTIONS = { wsToken: a?.wsToken }), n && (i.STORYBOOK_RENDERER = await (0, B.extractProperRendererNameFromFramework)(
  r) ?? void 0);
  let s = kt(t);
  s && (i.STORYBOOK_BUILDER = Ji(s) ?? Ui(s));
  let c = kt(await e.presets.apply("framework"));
  return c && (i.STORYBOOK_FRAMEWORK = c), i;
}, "buildFrameworkGlobalsFromOptions");

// src/builder-manager/utils/managerEntries.ts
var Ct = require("node:fs"), ee = require("node:fs/promises"), R = require("node:path"), At = require("@storybook/core/common");
var Lt = /* @__PURE__ */ o((e) => e.replaceAll(".", "").replaceAll("@", "").replaceAll(R.sep, "-").replaceAll("/", "-").replaceAll(new RegExp(
...
async function Nt(e, i) {
  return Promise.all(
    e.map(async (t, a) => {
      let { name: r, dir: n } = (0, R.parse)(t), s = (0, At.resolvePathInStorybookCache)("sb-manager", i);
      if (!s)
        throw new Error("Could not create/find cache directory");
      let c = (0, R.relative)(process.cwd(), n), p = (0, R.join)(
        s,
        Gi((0, R.join)(`${Lt(c)}-${a}`, `${Lt(r)}-bundle.js`))
      );
...
var Vi = /^\/($|\?)/, ie, D, xe = /* @__PURE__ */ o(async (e) => {
  let [i, t, a, r] = await Promise.all([
    ...
    Dt((0, k.join)(e.configDir, "manager")),
    fe("addon.tsconfig.json"),
    e.presets.apply("env")
  ]), n = t ? [...i, t] : i;
  return {
    entryPoints: await Nt(n, e.cacheKey),
    outdir: (0, k.join)(e.outputDir || "./", "sb-addons"),
    format: "iife",
    write: !1,
    ignoreAnnotations: !0,
  ...
  let h = (0, k.join)(
    (0, k.dirname)(require.resolve("@storybook/core/package.json")),
    "dist",
    "manager"
  );
  a.use(
  ...
  yield;
  let m = a.outdir, g = (0, k.join)(
    (0, k.dirname)(require.resolve("@storybook/core/package.json")),
    "dist",
    "manager"
  ), h = (0, k.join)(t.outputDir, "sb-manager");
  ie = await c({
    ...a,
    minify: !0
  }), yield;
  ...
  return await Promise.all([(0, I.writeFile)((0, k.join)(t.outputDir, "index.html"), E), y]), te.logger.trace({ message: "=> Manager built",
