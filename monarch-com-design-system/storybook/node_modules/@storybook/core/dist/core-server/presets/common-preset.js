...
var Ga = d((Z) => {
  ...
  var hg = I("os"), pg = I("path"), Ua = hg.platform() === "win32", dg = 2, fg = /(\\?)([()*?[\]{|}]|^!|[!+@](?=\()|\\(?![!()*+?@[\]{|}]))/g,
  mg = /(\\?)([()[\]{}]|^!|[!+@](?=\())/g, gg = /^\\\\([.?])/, yg = /\\(?![!()+@[\]{}])/g;
  function xg(t) {
    return t.replace(/\\/g, "/");
  }
  ...
  Z.convertPathToPattern = Ua ? Ba : Wa;
  function Ba(t) {
    return wi(t).replace(gg, "//$1").replace(yg, "/");
  }
  n(Ba, "convertWindowsPathToPattern");
  Z.convertWindowsPathToPattern = Ba;
  function Wa(t) {
    return Ri(t);
  }
...
var Ci = d((xP, xl) => {
  ...
  (t, e, r) => {
    ...
    return [];
  }, "invalidRange"), Bg = /* @__PURE__ */ n((t, e) => {
    if (e.strictRanges === !0)
    ...
    return i.toRegex === !0 ? r > 1 ? Ug(g, i, m) : ml(R, null, { wrap: !1, ...i }) : R;
    ...
    1), s) : r != null && !pl(r) ? Bg(r, s) : hr(t, e, 1, r);
  }, "fill");
  xl.exports = hr;
});
...
var Yl = d((DP, Vl) => {
  ...
  var Fl = $t(), {
    ...
    /* } */
    CHAR_RIGHT_PARENTHESES: Ul,
    /* ) */
    CHAR_RIGHT_SQUARE_BRACKET: Ly
    /* ] */
  } = Lt(), Bl = /* @__PURE__ */ n((t) => t === Gl || t === Mt, "isPathSeparator"), Wl = /* @__PURE__ */ n((t) => {
...
advance");
    ...
    r.noext === !0 && (b = !1, g = !1);
    let B = c, Ge = "", y = "";
    h > 0 && (Ge = c.slice(0, h), c = c.slice(h), m -= h), B && g === !0 && m > 0 ? (B = c.slice(0, m), y = c.slice(m)) : g === !0 ? (B = "",
    y = c) : B = c, B && B !== "" && B !== "/" && B !== c && Bl(B.charCodeAt(B.length - 1)) && (B = B.slice(0, -1)), r.unescape === !0 && (y &&
    (y = Fl.removeBackslashes(y)), B && $ === !0 && (B = Fl.removeBackslashes(B)));
    let x = {
      prefix: Ge,
      input: t,
      start: h,
    ...
    if (r.tokens === !0 && (x.maxDepth = 0, Bl(P) || a.push(q), x.tokens = a), r.parts === !0 || r.tokens === !0) {
      let ie;
...
var Ql = d((NP, Kl) => {
  ...
  (t, e) => {
    ...
    let V = [], B = [], Ge = [], y = o, x, ie = /* @__PURE__ */ n(() => _.index === s - 1, "eos"), M = _.peek = (S = 1) => t[_.index + S], Se = _.
...
*", y.output = ee, _.output += y.output);
    ...
    for (; !ie(); ) {
      ...
      if (x === "}") {
        ...
        L({ type: "brace", value: x, output: N }), it("braces"), B.pop();
        continue;
      }
      if (x === "|") {
...
var Zl = d((LP, Xl) => {
  "use strict";
  var Hy = I("path"), Uy = Yl(), Fi = Ql(), Hi = $t(), By = Lt(), Wy = /* @__PURE__ */ n((t) => t && typeof t == "object" && !Array.isArray(
...
var oc = d((qP, nc) => {
  "use strict";
  var rc = I("util"), ic = kl(), Re = ec(), Ui = $t(), tc = /* @__PURE__ */ n((t) => t === "" || t === "./", "isEmptyString"), sc = /* @__PURE__ */ n(
  (t) => {
    let e = t.indexOf("{");
  ...
  G.capture = (t, e, r) => {
    let i = Ui.isWindows(r), o = Re.makeRe(String(t), { ...r, capture: !0 }).exec(i ? Ui.toPosixSlashes(e) : e);
    if (o)
...
var fc = d((A) => {
  ...
  var Gy = I("path"), Vy = Za(), Bi = oc(), ac = "**", Yy = "\\", zy = /[*?]|^!/, Ky = /\[[^[]*]/, Qy = /(?:^|[^!*+?@])\([^(]*\|[^|]*\)/, Xy = /[!*+?@]\([^(]*\)/,
  Zy = /,|\.\./, Jy = /(?!^)\/{2,}/g;
  function lc(t, e = {}) {
    return !cc(t, e);
  }
...
var es = d((Sr) => {
  ...
  var Mc = Number.parseInt(Er[0], 10), jx = Number.parseInt(Er[1], 10), qc = 10, Fx = 10, Hx = Mc > qc, Ux = Mc === qc && jx >= Fx;
  Sr.IS_SUPPORT_READDIR_WITH_FILE_TYPES = Hx || Ux;
});
...
var jc = d((vr) => {
  ...
  n(Bx, "createDirentFromStats");
  vr.createDirentFromStats = Bx;
});
...
var Gc = d((ze) => {
  ...
  var Vx = lt(), Fc = $c(), Yx = es(), Hc = rs(), Uc = is();
  function zx(t, e, r) {
  ...
  function Bc(t, e, r) {
    e.fs.readdir(t, { withFileTypes: !0 }, (i, s) => {
      ...
      let o = s.map((l) => ({
        dirent: l,
        name: l.name,
        path: Uc.joinPathSegments(t, l.name, e.pathSegmentSeparator)
      }));
  ...
  n(Bc, "readdirWithFileTypes");
  ze.readdirWithFileTypes = Bc;
  function Kx(t, e) {
    return (r) => {
  ...
  function Wc(t, e, r) {
    e.fs.readdir(t, (i, s) => {
      ...
      let o = s.map((a) => {
        let l = Uc.joinPathSegments(t, a, e.pathSegmentSeparator);
        return (c) => {
...
var hu = d((Ns) => {
  ...
  var F_ = Ir(), H_ = Nr(), U_ = Ds(), Is = class extends H_.default {
    static {
      n(this, "ReaderAsync");
    }
    constructor() {
      super(...arguments), this._walkAsync = F_.walk, this._readerStream = new U_.default(this._settings);
    }
    dynamic(e, r) {
...
var du = d((Ms) => {
  ...
  var B_ = pu(), $s = class extends B_.default {
    static {
...
var AC, Tu, PC, OC, Au, CC, Pu = he(() => {
  n(ln, "isType");
  n(cn, "isTypeSync");
  AC = ln.bind(null, "stat", "isFile"), Tu = ln.bind(null, "stat", "isDirectory"), PC = ln.bind(null, "lstat", "isSymbolicLink"), OC = cn.bind(
  null, "statSync", "isFile"), Au = cn.bind(null, "statSync", "isDirectory"), CC = cn.bind(null, "lstatSync", "isSymbolicLink");
});
...
var xn, Fu, Lb, Hu, Mr, $b, Mb, qb, Uu, Bu, _n, bn, Wu, Gu, En = he(() => {
...
ttern"), Mb = /* @__PURE__ */ n((t, e) => {
    ...
    let { cwd: r, suppressErrors: i, deep: s, ignore: o } = Bu(e), a = await (0, xn.default)(t, {
      cwd: r,
      suppressErrors: i,
      deep: s,
      ignore: o,
    ...
    let { cwd: r, suppressErrors: i, deep: s, ignore: o } = Bu(e), l = xn.default.sync(t, {
      cwd: r,
      suppressErrors: i,
      deep: s,
      ignore: o,
...
var wt, Fb, Ku, Qu, Vu, Yu, Sn, Hb, Xu, Zu, qr, Ju, Ub, eh, th, rh, ih, sh, nh, vn, Bb, Wb, Gb, Vb, Yb, zb, Kb, ah = he(() => {
  qa();
  wt = pe(an(), 1);
  Pu();
  un();
  ...
  }, "getIgnoreFilesPatterns"), Ub = /* @__PURE__ */ n(async (t) => {
    let e = Ju(t);
    return th(
  ...
  }, "generateTasksSync"), Bb = Zu(async (t, e) => {
    let [
      r,
      i
    ] = await Promise.all([
...
var Zh = d((P0, Xh) => {
  ...
  }), cS = /* @__PURE__ */ n((t) => kn[t] || kn.default, "render"), Ut = Object.freeze({
    aborted: Rt.red(ut.cross),
    done: Rt.green(ut.tick),
    exited: Rt.yellow(ut.cross),
    default: Rt.cyan("?")
  }), uS = /* @__PURE__ */ n((t, e, r) => e ? Ut.aborted : r ? Ut.exited : t ? Ut.done : Ut.default, "symbol"), hS = /* @__PURE__ */ n((t) => Rt.
...
var dp = d(($0, pp) => {
  ...
  var Ur = z(), bS = qe(), hp = Q(), ES = hp.erase, Bt = hp.cursor, Br = be(), $n = Br.style, Mn = Br.clear, SS = Br.lines, vS = Br.figures,
  qn = class extends bS {
    static {
      n(this, "TextPrompt");
    }
...
`), e.close();
    ...
    render() {
      this.closed || (this.firstRender || (this.outputError && this.out.write(Bt.down(SS(this.outputError, this.out.columns) - 1) + Mn(this.
      ...
      [$n.symbol(this.done, this.aborted), Ur.bold(this.msg), $n.delimiter(this.done), this.red ? Ur.red(this.rendered) : this.rendered].join(
      " "), this.error && (this.outputError += this.errorMsg.split(`
`).reduce((e, r, i) => e + `
${i ? " " : vS.pointerSmall} ${Ur.red().italic(r)}`, "")), this.out.write(ES.line + Bt.to(0) + this.outputText + Bt.save + this.outputError +
      Bt.restore + Bt.move(this.cursorOffset, 0)));
    }
  };
  pp.exports = qn;
});
...
var Pp = d((V0, Ap) => {
  "use strict";
  var NS = Pe(), kS = /* @__PURE__ */ n((t) => (t = t % 10, t === 1 ? "st" : t === 2 ? "nd" : t === 3 ? "rd" : "th"), "pos"), Bn = class extends NS {
    static {
      n(this, "Day");
    }
    constructor(e = {}) {
...
var Zp = d((a1, Xp) => {
  ...
  var Qn = z(), HS = qe(), Zn = be(), Gp = Zn.style, Vp = Zn.clear, US = Zn.figures, Qp = Q(), BS = Qp.erase, Yp = Qp.cursor, Fe = Up(), zp = Fe.
...
`), e.close();
    ...
    render() {
      ...
      split(`
`).reduce((e, r, i) => e + `
${i ? " " : US.pointerSmall} ${Qn.red().italic(r)}`, "")), this.out.write(BS.line + Yp.to(0) + this.outputText));
    }
  };
  Xp.exports = Xn;
});
...
var Wd = d((T1, Bd) => {
  "use strict";
  var Iv = Qr(), { erase: Ud, cursor: Nv } = Q(), kv = /* @__PURE__ */ n((t) => [...Iv(t)].length, "width");
  Bd.exports = function(t, e) {
    if (!e) return Ud.line + Nv.to(0);
    let r = 0, i = t.split(/\r?\n/);
    for (let s of i)
...
var Ue = d((L1, rf) => {
  "use strict";
  var tf = I("readline"), { action: Uv } = Ee(), Bv = I("events"), { beep: Wv, cursor: Gv } = Q(), Vv = z(), mo = class extends Bv {
    static {
      n(this, "Prompt");
    }
    constructor(e = {}) {
...
var nf = d((M1, sf) => {
  var Xr = z(), Yv = Ue(), { erase: zv, cursor: Qt } = Q(), { style: go, clear: yo, lines: Kv, figures: Qv } = Ee(), xo = class extends Yv {
    static {
      n(this, "TextPrompt");
    }
    constructor(e = {}) {
...
var cf = d((j1, lf) => {
  "use strict";
  var Be = z(), Xv = Ue(), { style: of, clear: af, figures: Zr, wrap: Zv, entriesToDisplay: Jv } = Ee(), { cursor: ew } = Q(), _o = class extends Xv {
    static {
      n(this, "SelectPrompt");
    }
    constructor(e = {}) {
...
`;
  ...
  ") + o) : (s = this.cursor === i ? Be.cyan().underline(l.title) : l.title, o = (this.cursor === i ? Be.cyan(Zr.pointer) + " " : "  ") + o,
          l.description && this.cursor === i && (a = ` - ${l.description}`, (o.length + s.length + a.length >= this.out.columns || l.description.
          split(/\r?\n/).length > 1) && (a = `
` + Zv(l.description, { margin: 3, width: this.out.columns })))), this.outputText += `${o} ${s}${Be.gray(a)}
`;
        }
      }
      this.out.write(this.outputText);
...
var df = d((H1, pf) => {
  var Jr = z(), tw = Ue(), { style: uf, clear: rw } = Ee(), { cursor: hf, erase: iw } = Q(), bo = class extends tw {
    static {
      n(this, "TogglePrompt");
    }
    constructor(e = {}) {
...
var jf = d((lI, qf) => {
  "use strict";
  var Co = z(), dw = Ue(), { style: Nf, clear: kf, figures: fw } = Ee(), { erase: mw, cursor: Lf } = Q(), { DatePart: $f, Meridiem: gw, Day: yw,
...
var Bf = d((uI, Uf) => {
  var ei = z(), Tw = Ue(), { cursor: ti, erase: Aw } = Q(), { style: Io, figures: Pw, clear: Ff, lines: Ow } = Ee(), Cw = /[0-9]/, No = /* @__PURE__ */ n(
...
var $o = d((pI, Vf) => {
  "use strict";
  var Ie = z(), { cursor: Dw } = Q(), Iw = Ue(), { clear: Wf, figures: tt, style: Gf, wrap: Nw, entriesToDisplay: kw } = Ee(), Lo = class extends Iw {
    static {
      n(this, "MultiselectPrompt");
    }
    constructor(e = {}) {
...
var Xf = d((fI, Qf) => {
  "use strict";
  var Xt = z(), Lw = Ue(), { erase: $w, cursor: Yf } = Q(), { style: Mo, clear: zf, figures: qo, wrap: Mw, entriesToDisplay: qw } = Ee(), Kf = /* @__PURE__ */ n(
...
var tm = d((gI, em) => {
  "use strict";
  var We = z(), { cursor: Hw } = Q(), Uw = $o(), { clear: Zf, style: Jf, figures: Pt } = Ee(), Fo = class extends Uw {
    static {
      n(this, "AutocompleteMultiselectPrompt");
    }
    constructor(e = {}) {
...
var om = d((xI, nm) => {
  var rm = z(), Bw = Ue(), { style: im, clear: Ww } = Ee(), { erase: Gw, cursor: sm } = Q(), Ho = class extends Bw {
    static {
      n(this, "ConfirmPrompt");
    }
    constructor(e = {}) {
...
var dm = d((vI, pm) => {
  "use strict";
  var Uo = um(), zw = ["suggest", "format", "onState", "validate", "onRender", "type"], hm = /* @__PURE__ */ n(() => {
  }, "noop");
  async function rt(t = [], { onSubmit: e = hm, onCancel: r = hm } = {}) {
    ...
    for (a of t)
      if ({ name: c, type: u } = a, typeof u == "function" && (u = await u(o, { ...i }, a), a.type = u), !!u) {
        ...
        try {
          o = rt._injected ? Kw(rt._injected, a.initial) : await Uo[u](a), i[c] = o = await m(a, o, !0), l = await e(a, o, i);
        } catch {
          l = !await r(a, i);
        }
        if (l) return i;
  ...
  n(Xw, "override");
  pm.exports = Object.assign(rt, { prompt: rt, prompts: Uo, inject: Qw, override: Xw });
});
...
var Sm = pe(st(), 1);
import { randomUUID as gR } from "node:crypto";
import { existsSync as Vo } from "node:fs";
import { readFile as yR } from "node:fs/promises";
import { dirname as si, isAbsolute as xR, join as Zt } from "node:path";
import {
  getDirectoryFromWorkingDir as _R,
  getPreviewBodyTemplate as bR,
  getPreviewHeadTemplate as ER,
  loadEnvs as SR,
  removeAddon as bm
} from "@storybook/core/common";
import { telemetry as ii } from "@storybook/core/telemetry";
import { readCsf as vR } from "@storybook/core/csf-tools";
import { logger as wR } from "@storybook/core/node-logger";

// ../addons/test/src/constants.ts
var ai = "storybook/test", li = `${ai}/test-provider`, IR = `${ai}/panel`;
var Ko = "writing-tests/test-addon", NR = `${Ko}#what-happens-when-there-are-different-test-results-in-multiple-environments`, kR = `${Ko}#w\
...
var {
  CHANNEL_WS_DISCONNECT: MR,
  CHANNEL_CREATED: qR,
  CONFIG_ERROR: jR,
  CREATE_NEW_STORYFILE_REQUEST: FR,
  CREATE_NEW_STORYFILE_RESPONSE: HR,
  CURRENT_STORY_WAS_SET: UR,
  DOCS_PREPARED: BR,
  DOCS_RENDERED: WR,
  FILE_COMPONENT_SEARCH_REQUEST: GR,
  FILE_COMPONENT_SEARCH_RESPONSE: VR,
  FORCE_RE_RENDER: YR,
  FORCE_REMOUNT: zR,
  GLOBALS_UPDATED: KR,
  NAVIGATE_URL: QR,
  PLAY_FUNCTION_THREW_EXCEPTION: XR,
  UNHANDLED_ERRORS_WHILE_PLAYING: ZR,
  PRELOAD_ENTRIES: JR,
  PREVIEW_BUILDER_PROGRESS: eT,
  PREVIEW_KEYDOWN: tT,
  REGISTER_SUBSCRIPTION: rT,
  RESET_STORY_ARGS: iT,
  SELECT_STORY: sT,
  SET_CONFIG: nT,
  SET_CURRENT_STORY: oT,
  SET_FILTER: aT,
  SET_GLOBALS: lT,
  SET_INDEX: cT,
  SET_STORIES: uT,
  SHARED_STATE_CHANGED: hT,
  SHARED_STATE_SET: pT,
  STORIES_COLLAPSE_ALL: dT,
  STORIES_EXPAND_ALL: fT,
  STORY_ARGS_UPDATED: mT,
  STORY_CHANGED: gT,
  STORY_ERRORED: yT,
  STORY_INDEX_INVALIDATED: xT,
  STORY_MISSING: _T,
  STORY_PREPARED: bT,
  STORY_RENDER_PHASE_CHANGED: ET,
  STORY_RENDERED: ST,
  STORY_FINISHED: vT,
  STORY_SPECIFIED: wT,
  ...
  STORY_UNCHANGED: TT,
  UPDATE_GLOBALS: AT,
  UPDATE_QUERY_PARAMS: PT,
  UPDATE_STORY_ARGS: OT,
  REQUEST_WHATS_NEW_DATA: CT,
  RESULT_WHATS_NEW_DATA: DT,
  SET_WHATS_NEW_CACHE: IT,
  TOGGLE_WHATS_NEW_NOTIFICATIONS: NT,
  TELEMETRY_ERROR: kT,
  SAVE_STORY_REQUEST: LT,
  SAVE_STORY_RESPONSE: $T,
  ARGTYPES_INFO_REQUEST: MT,
  ARGTYPES_INFO_RESPONSE: qT,
  TESTING_MODULE_CRASH_REPORT: Xo,
  TESTING_MODULE_PROGRESS_REPORT: Zo,
  TESTING_MODULE_RUN_REQUEST: jT,
  TESTING_MODULE_RUN_ALL_REQUEST: FT,
...
import {
  ...
  rendererPackages as Um
} from "@storybook/core/common";
import { isCsfFactoryPreview as Bm } from "@storybook/core/csf-tools";

// src/csf-tools/ConfigFile.ts
var oa = pe(st(), 1);
import { readFile as rA, writeFile as iA } from "node:fs/promises";
import {
  babelParse as na,
  generate as ia,
  recast as nA,
...
async function Aa({
  ...
  let o = Hm(), a = await Fm(s), l = await qm(a), c = Object.entries(Um).find(
    ([, k]) => k === l
...
import { existsSync as HE, statSync as l0 } from "node:fs";
import { basename as u0, isAbsolute as UE, posix as BE, resolve as WE, sep as GE, win32 as VE } from "node:path";
import { getDirectoryFromWorkingDir as p0 } from "@storybook/core/common";
import { logger as f0 } from "@storybook/core/node-logger";
var qh = /* @__PURE__ */ n((t) => {
  let e = t.lastIndexOf(":"), i = VE.isAbsolute(t) && e === 1, s = e !== -1 && !i ? e : t.length, a = (t.substring(s + 1) || "/").split(GE).
  join(BE.sep), l = t.substring(0, s), c = UE(l) ? l : `./${l}`, u = WE(c), h = a.replace(/^\/?/, "./"), m = h.substring(1);
  if (!HE(u))
    throw new Error(
      Mh.dedent`
...
var gm = pe(mm(), 1);
import { cache as Bo, loadAllPresets as Jw } from "@storybook/core/common";
import { getPrecedingUpgrade as eR, oneWayHash as tR, telemetry as rR } from "@storybook/core/telemetry";
import { logger as CI } from "@storybook/core/node-logger";
var iR = /* @__PURE__ */ n(async () => {
  ...
  return await Bo.set("enableCrashReports", t), t;
}, "promptCrashReports");
async function sR({
  cliOptions: t,
  presetOptions: e,
  ...
  if (s?.disableTelemetry)
    return "none";
  let o = await Bo.get("enableCrashReports") ?? await Bo.get("enableCrashreports");
  if (o !== void 0)
    return o ? "full" : "error";
  if (r)
    return "error";
...
// src/core-server/presets/common-preset.ts
var RR = /* @__PURE__ */ n((t, e = {}) => Object.entries(e).reduce((r, [i, s]) => r.replace(new RegExp(`%${i}%`, "g"), s), t), "interpolate"),
Em = Zt(
  ...
  ...hh,
  ...t
], "staticDirs"), aN = /* @__PURE__ */ n(async (t, e) => {
  if (t)
    return t;
  ...
  if (i.length > 0) {
    ...
    return o.length > 1 && wR.warn(Sm.dedent`
  ...
  return Em;
}, "favicon"), lN = /* @__PURE__ */ n(async (t, e) => {
...
}, "babel"), cN = /* @__PURE__ */ n((t, e) => t || e.packageJson?.name || !1, "title"), uN = /* @__PURE__ */ n((t, e) => t || e.loglevel || "\
info", "logLevel"), hN = /* @__PURE__ */ n(async (t, { configDir: e, presets: r }) => {
  let i = await r.apply("env");
  return ER(e, i);
}, "previewHead"), pN = /* @__PURE__ */ n(async () => SR({ production: !0 }).raw, "env"), dN = /* @__PURE__ */ n(async (t, { configDir: e, presets: r }) => {
  let i = await r.apply("env");
  return bR(e, i);
}, "previewBody"), fN = /* @__PURE__ */ n(() => ({
  check: !1,
...
don")), { ...t, removeAddon: r };
}, "experimental_serverAPI"), AR = gR(), gN = /* @__PURE__ */ n(async (t, e) => ({
  ...t,
  channelOptions: {
    ...t?.channelOptions ?? {},
    ...e.configType === "DEVELOPMENT" ? { wsToken: AR } : {}
  },
  disableTelemetry: e.disableTelemetry === !0 || e.test === !0,
  enableCrashReports: e.enableCrashReports || TR(process.env.STORYBOOK_ENABLE_CRASH_REPORTS)
}), "core"), yN = /* @__PURE__ */ n(async (t) => ({
  ...t,
  argTypeTargetsV7: !0,
  ...
  createIndex: /* @__PURE__ */ n(async (t, e) => (await vR(t, e)).parse().indexInputs, "createIndex")
}, xN = /* @__PURE__ */ n((t) => [PR].concat(t || []), "experimental_indexers"), _N = /* @__PURE__ */ n(async (t, e) => {
  let r = await e.presets.apply("framework");
  return typeof r == "string" ? {} : typeof r > "u" ? null : r.options;
}, "frameworkOptions"), bN = /* @__PURE__ */ n((t, { docs: e }) => t && e !== void 0 ? {
  ...t,
  docsMode: e
} : t, "docs"), EN = /* @__PURE__ */ n(async (t, e) => {
  let r = Zt(e.configDir, "manager-head.html");
  if (Vo(r)) {
    let i = yR(r, { encoding: "utf8" }), s = e.presets.apply("env");
    return RR(await i, await s);
  }
  return "";
}, "managerHead"), SN = /* @__PURE__ */ n(async (t) => t, "channelToken"), vN = /* @__PURE__ */ n(async (t, e) => {
...
}, "experimental_serverChannel"), wN = /* @__PURE__ */ n(async (t) => {
  try {
    return {
      ...t,
...
export {
  ...
  bN as docs,
  pN as env,
  xN as experimental_indexers,
  mN as experimental_serverAPI,
  vN as experimental_serverChannel,
  aN as favicon,
  yN as features,
  _N as frameworkOptions,
  uN as logLevel,
  TN as managerEntries,
  EN as managerHead,
  dN as previewBody,
  hN as previewHead,
  wN as resolvedReact,
